...
class itl:
    ...
    def cant_survey(self, cant_num):
        ...
        fscan = cantilever_select(cant_num)
        num_scans = 4
        fstep_coarse = 2.0
        fstep_fine = 0.1
...
def cantilever_select(cant_num):
...
def tip_centre(cant_num):
    ...
    return common.lin_centre_pos[cant_num-1]


def tip_position(cant_num, distance):
