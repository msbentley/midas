...
class itl:
    ...
    def __init__(self, obs=None, model='FM', start=None, end=None, shut_open=True):
    ...
    def set_auto_retract(self, safety_factor=2.0, min_zr=500.):
        ...
        the auto-retract can also be set with min_zr= (nm)"""
