...
valid_obs_names = [ 'TARGET_SCAN', 'TARGET_EXPOSE', 'MIDAS__SCI__MTP003', 'MD_TARGET_SCAN', 'MIDAS__SCI', 'TARGET_EXPOSE_SCAN']
...
class itl:
    ...
    def __init__(self, obs=None, model='FM'):
        ...
        if obs is None: # create a dummy observation for testing or FS operations
            self.current_obs = pd.Series({
                ...
                'obs_id': 1,
                'start_time': pd.Timestamp('2015-01-01 00:00'),
                'end_time': pd.Timestamp('2015-12-31 00:00'),
                'duration': pd.Timestamp('2015-12-31 00:00') - pd.Timestamp('2015-01-01 00:00'),
                'start_id': 'DUMMY______________________SO',
                'end_id': 'DUMMY______________________EO' })
